...
-- Hub: Shared Themes Table (public, profile-scoped)
...
-- Hub: Shared Variations Table (public, profile-scoped)
...
-- Hub: Theme Favorites Table (tracks who favorited what)
...
-- Hub: Variation Favorites Table (tracks who favorited what)
