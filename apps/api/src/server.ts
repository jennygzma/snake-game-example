...
import { createVariationRouter } from "./routes/variationRoutes";
import { createHubRouter } from "./routes/hubRoutes";
...
app.use("/v1/variations", createVariationRouter(db));
app.use("/v1/hub", createHubRouter(db));
